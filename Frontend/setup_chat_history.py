...
def setup_chat_history(tab, user_id):
    ...
    try:
        ...
        if chats:
            ...
            if start_date and end_date:
                ...
                reselect_button = ctk.CTkButton(tab, text="Reselect Dates", command=lambda: setup_by_date_tab(tab, user_id))
                reselect_button.pack(pady=10)

        else:
            messagebox.showinfo("No Chats", "No chat history found for the given filters.")
            setup_by_date_tab(tab, user_id)
